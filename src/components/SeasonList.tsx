  ...
  return (
    <div className="mt-14 w-full">
      <div className="flex items-center gap-3 mb-8 border-b border-slate-700/60 pb-4">
        <h2 className="text-3xl font-extrabold text-white tracking-tight">Sezon Odaları</h2>
        <span className="bg-indigo-600/20 text-indigo-400 text-sm font-bold px-3 py-1 rounded-full">
